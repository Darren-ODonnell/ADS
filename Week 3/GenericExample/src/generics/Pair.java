/* This class is a definition of a new entity that I'm calling Pair. This will allow me to 
...
public class Pair <Point>{
	...
	public Pair(Point firstItem, Point secondItem)
	{
	...
	public void setSecond(Point newSecond)
	{
...
//how to compare two pairs.
	...
	{
		Pair<Point> otherPair = (Pair<Point>) otherObject;
